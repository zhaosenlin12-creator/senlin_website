...
export const ACHIEVEMENT_ITEMS = [
  ...
  },
  {
    num: "02",
    title: "机器人赛事与项目化成果",
    desc: "围绕编程、机器人和综合实践项目，持续产出真实可展示的团队成果。",
  },
  {
    num: "03",
    title: "课程研发与教学服务闭环",
    desc: "不仅能教，也能把课程、工具、反馈和作品展示组织成完整的学习体验。",
  },
];
...
export const LEARNING_NODES = [
  {
    ...
    title: "Python",
    subtitle: "从兴趣入门到作品表达",
    description: "用闯关、图形化任务和真实小项目，把语法学习转化成可见的创作体验。",
    chips: ["游戏化", "项目作品", "即时反馈"],
  },
  {
    id: "cpp",
    title: "C++ / NOI",
    subtitle: "竞赛思维与算法训练",
    description: "用清晰的路线拆解数据结构、算法策略和题目表达，让训练过程更有方向。",
    chips: ["算法", "数据结构", "竞赛路径"],
  },
  {
    id: "ai",
    title: "AI 课堂",
    subtitle: "把新工具接入学习现场",
    description: "让学生理解 AI 的能力边界，并把提示词、生成内容和研究过程变成课堂材料。",
