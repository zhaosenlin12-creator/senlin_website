...
export const STAGE_APPS = [
  ...
  },
  {
    ...
    category: "课堂服务中枢",
    kicker: "Teaching Service Console",
    description: "把课堂组织、资源入口、学习反馈与教学服务放进统一系统，是后续应用分支的管理中枢。",
    highlights: ["课堂入口", "服务闭环", "多应用分发"],
    accent: "amber",
    posterTitle: "Class System",
    posterSubtitle: "Class / Service / Growth",
...
export const APP_SHOWCASE_ITEMS = [
  ...
  },
  {
    ...
    category: "科学仿真",
    summary: "把抽象科学概念转换为可拖拽、可调参、可观察的仿真实验入口。",
    palette: "indigo",
    poster: {
      eyebrow: "SIM LAB",
      title: "Observe / Tweak",
  ...
  },
  {
    ...
    category: "基础能力训练",
    summary: "把打字速度、准确率和等级反馈做成练习系统，适合低门槛进入编程课堂。",
    palette: "teal",
    poster: {
      eyebrow: "TYPING LAB",
      title: "Speed / Focus",
  ...
  },
  {
    ...
    category: "AI 实验",
    summary: "用样本、训练和结果反馈帮助学生理解模型思维，而不只停留在工具使用。",
    palette: "violet",
    poster: {
